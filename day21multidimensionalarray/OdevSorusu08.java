...
public class OdevSorusu08 {
	...
	public static void main(String[] args) {
		// OdevSorusu08
		// Soru : clear() methodu kullanarak, list’deki tum elemanları siliniz.
		...
		// OdevSorusu09
		// Soru : isEmpty() methodu kullanarak, list’deki tum elemanların silindiğini doğrulayınız.
		System.out.println(list.isEmpty()); // ekranda true yazar. Yani list icerisinde birsey yok demek
