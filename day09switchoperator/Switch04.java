...
public class Switch04 {
	public static void main(String[] args) {
		// Kullanıcıdan notunu alın ve aşağıdaki kurallara göre ekrana A, B, C veya D
		// yazdırın.
		// 1. 0()dahil ile 50 arasi - D 2. 50(dahil) ile 60 arası - C 3. 60(dahil) ile
		// 80 arası - B 4. 80(dahil) ustu- A
