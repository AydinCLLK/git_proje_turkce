...
public class Encapsulation01 {
	...
	private String kimlikNo = "12341234123";
	...
	public static void main(String[] args) {
		...
		// getter() data’yi sadece okumamiza yarar, getter() methodu data’da degisiklik
		// yapamaz.
	...
	// return type boolean ise; getter() method'un ismi "is" ile baslar. "get"
	// kullanilmaz
