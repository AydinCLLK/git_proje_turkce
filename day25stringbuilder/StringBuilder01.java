...
public class StringBuilder01 {
	...
	public static void main(String[] args) {
		...
		// ilk urettiginiz String'i etkilemez. Ama illaki ilk urettigim String degissin
		...
		// StringBuilder Class'ini kullanarak String uretirseniz yaptiginiz
		// degisiklikler
		...
		System.out.println(strbld);// AyseCan
